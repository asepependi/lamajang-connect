...
<div class="container mt-5">
    <h2 class="mb-4" style="color: #033D44; font-weight: 700;">FORM UPDATE DATA PENGINAPAN</h2>
    <form action="{{ route($route.'update', $data->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="jam-masuk-keluar" name="jam_masuk_keluar" placeholder="Silahkan Masukkan Jam Masuk Keluar" required autocomplete="off" value="{{ $data->jam_masuk_keluar }}">
        </div>
        <div class="form-group">
