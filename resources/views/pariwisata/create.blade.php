...
<div class="container mt-5">
    <h2 class="mb-4" style="color: #033D44; font-weight: 700;">FORM INPUT DATA PARIWISATA</h2>
    <form action="{{ route($route.'store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="jam-buka" name="jam_buka" placeholder="Silahkan Masukkan Jam Buka" required autocomplete="off">
        </div>
        <div class="form-group">
