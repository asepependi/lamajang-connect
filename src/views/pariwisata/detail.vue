        ...
        <div class="row align-items-center justify-content-center pt-5 pb-5" style="background-color: #033D44;">
          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="mt-5 mt-lg-0">
              ...
              <a href="https://api.whatsapp.com/send?text=Hallo, Admin Lamajang Connect, Saya Dapat Info dari Website Mengenai Pemesanan Pariwisata&source=&phone=+6281220618341" 
              ...
              <p style="font-weight: 300;color: white;">
                Jam buka: {{data_detail.jam_buka}} WIB
              </p>
              <p style="font-weight: 300;color: white;">
...
<script>
  ...
  export default {
    ...
    methods: {
      getData(){
        MasterData.pariwisataDetail(this.id).then((res) => {
          if (res.data.status) {
